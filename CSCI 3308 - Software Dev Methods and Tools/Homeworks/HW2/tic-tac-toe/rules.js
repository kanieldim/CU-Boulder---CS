...
function begin_play()
{
	...
	{
		alert("No!!! This is a two player game, both of the fields are mandatory.")
		return
	}
...
function reset_play()
{
	var firstPlayer = document.getElementById("player1_id");
	var secondPlayer = document.getElementById("player2_id");
	var cellBox = document.getElementById("move_text_id");
